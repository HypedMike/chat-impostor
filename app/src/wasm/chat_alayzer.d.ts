 ...
 */
export function import_chat(content: string): void;

/**
 * Picks a word out of the most recently imported chat, weighted by how often it occurs.
 */
export function pick_word(): string | undefined;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly import_chat: (a: number, b: number) => void;
    readonly pick_word: () => [number, number];
